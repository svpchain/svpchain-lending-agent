...
type EVMDeps struct {
	...
	// build_swap, none of which this binary serves) to a UniswapV2Router02 +
	// WSVP deployment. Retained because get_balance and evm_tx_status read the
	// binding for token labels. Nil unless both
