...
func TestRetiredEVMDeFiKeysAreIgnoredNotRejected(t *testing.T) {
	body := minimal + `
...
evm.oracle.feed_addr         = "0x0000000000000000000000000000000000000003"
...
`
	if _, err := Load(writeConfig(t, body)); err != nil {
		t.Errorf("a config carrying the retired evm DeFi blocks must still load, got %v", err)
	}
}
